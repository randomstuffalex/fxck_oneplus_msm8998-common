...
public class Constants {
    ...
    // Preference keys
    public static final String NOTIF_SLIDER_TOP_KEY = "keycode_bottom_position";
    public static final String NOTIF_SLIDER_MIDDLE_KEY = "keycode_middle_position";
    public static final String NOTIF_SLIDER_BOTTOM_KEY = "keycode_top_position";

    // Button prefs
    public static final String NOTIF_SLIDER_TOP_PREF = "pref_keycode_bottom_position";
    public static final String NOTIF_SLIDER_MIDDLE_PREF = "pref_keycode_middle_position";
    public static final String NOTIF_SLIDER_BOTTOM_PREF = "pref_keycode_top_position";
